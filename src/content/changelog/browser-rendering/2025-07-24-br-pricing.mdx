...
You will be able monitor usage via the [Cloudflare dashboard](https://dash.cloudflare.com/). Go to **Compute (Workers)** > **Browser Rendering**. 

![Browser Rendering dashboard](~/assets/images/browser-rendering/dashboard.png)

If you've been using Browser Rendering but do not wish to incur charges, ensure your usage stays within your plan's [included usage](/browser-rendering/platform/pricing/). You can also review [example pricing scenarios](/browser-rendering/platform/pricing/#examples-of-workers-paid-pricing) to better estimate your costs. 
