...
The dashboard will display **Open links evaluated as suspicious in a remote browser (Recommended)**. This option is turned on by default. Email Security will allow you to select message dispositions to open all links in a remote browser. 
